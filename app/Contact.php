...
class Contact extends Model
{
	...
	public $fillable = ['no_id','nama','no_npwp','npwp_sejak','sejak','alamat_1','alamat_2','no_ktp','kode_negara','status_pindah','no_rekening','bagian','jabatan','status_k_tk_hb','tanggungan','jenis_kelamin','ka','kode_objek_pajak','mulai_kerja','akhir_kerja','kend','rumah','obat','uang','lain','pl_obat','gaji','tanggal_in','jml_bulan_in','pengh_in','pph_in','tanggal_out','bulan_out','tanggal_lahir'];

	public static function UpdateContact($no_id,$nama,$no_npwp,$npwp_sejak,$no_urut,$sejak,$alamat_1,$alamat_2,$no_ktp,$kode_negara,$status_pindah,$no_rekening,$bagian,$jabatan,$status_k_tk_hb,$tanggungan,$jenis_kelamin,$ka,$kode_objek_pajak,$mulai_kerja,$akhir_kerja,$kend,$rumah,$obat,$uang,$lain,$pl_obat,$gaji,$tanggal_in,$jml_bulan_in,$pengh_in,$pph_in,$tanggal_out,$bulan_out,$tanggal_lahir){
		$data = array(
			'no_id' => $no_id,
			'nama' => $nama,
			'no_npwp' => $no_npwp,
		...
		return self::where('no_urut', '=', $no_urut)
				->update($data);
	}
}
