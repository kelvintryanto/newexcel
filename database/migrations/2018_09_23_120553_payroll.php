    ...
    public function up()
     {
        Schema::create('payroll', function (Blueprint $table) {
            ...
            $table->string('gaji_pokok')->nullable(); //5
            ...
            $table->string('sub_total_pengeluaran')->nullable(); //35
